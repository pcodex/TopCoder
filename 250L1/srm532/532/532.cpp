...
int DengklekTryingToSleep::minDucks(vector <int> ducks)
{
	...
	int range = ducks[ducks.size() - 1] - ducks[0] + 1;

	int miss = range - ducks.size();
